...
//	Constructor
	...
	/*@After annotation is used on a method containing java code to run after each test case. These methods will run
	 *  even if any exceptions are thrown in the test case or in the case of assertion failures.*/
	@After
