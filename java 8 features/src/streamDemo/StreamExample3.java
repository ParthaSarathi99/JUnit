...
//		Collect Operation --> Convert String to list
...
//		Count Operations
		...
		System.out.println("No. of name starting with A: "+cnt1);

//		Reduce operations -->  combines elements of a stream and produce a single value
